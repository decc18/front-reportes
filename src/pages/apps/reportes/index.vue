...
const closeDialog = async () => {
  if (selectedItems.value.length === 0) {
    alert('Debe haber al menos un email seleccionado.')
  } else {
...
const eliminarReporte = async (confirmed: boolean) => {
  ...
  if (confirmed) {
    try {
      ...
      messageHelper.throwError(error)
    }
  }
    ...
    >
      ...
      <VCard title="Enviar Correo">
        ...
        <VCardText class="d-flex justify-end flex-wrap gap-4">
          ...
          <VBtn :disabled="selectedItems.length === 0"  @click="closeDialog">
            Aceptar
          </VBtn>
        </VCardText>
      </VCard>
        ...
        <VCardText>
          ...
          >
            ...
            >
              ...
              <div class="app-timeline-text mt-1">{{ item.accionDetalle }}</div>
            </VTimelineItem>
          </VTimeline>
        </VCardText>
        <VCardText class="d-flex justify-end flex-wrap gap-4">
